...
function showModal(app) {
  ...
  document.getElementById('modalContent').innerHTML = `
    ...
    <strong><label id="q1-label">질문 1</label><textarea id="q1" required></strong><pre>${app.q1}</pre>
    <strong><label id="q1-label">질문 1</label><textarea id="q1" required></strong><pre>${app.q2}</pre>
